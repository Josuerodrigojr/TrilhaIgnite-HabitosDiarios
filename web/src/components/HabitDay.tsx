...
const [completed, setCompleted] = useState(defaultCompleted)
  ...
  return (
    <Popover.Root>
      <Popover.Trigger
        className={clsx("w-10 h-10 bg-zinc-900 border-2 border-zinc-800 rounded-lg transition-colors focus:outline-none focus:rind-2 focus:ring-violet-700 focus:ring-offset-2 focus:ring-offset-background", {
